...
import { ChevronsLeft, ChevronsRight, Heart, Clock, Flame } from 'lucide-react';
    ...
    <>
      ...
      <aside className="fixed right-0 top-0 h-screen bg-zinc-900 border-l border-gray-800 z-60 w-16">
        ...
        <button
          ...
          className="w-full py-4 flex items-center justify-center text-gray-400 hover:text-white transition-colors cursor-pointer"
        >
          {activePanel ? (
        ...
        <nav className="flex flex-col">
          {menuItems.map((item, index) => (
            <button
              ...
              className={`flex flex-col items-center gap-1 py-4 transition-colors cursor-pointer ${
